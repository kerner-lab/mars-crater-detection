...
model = UNetFormer(pretrained=True,num_classes=1)
model.to(0)
...
train_data = MyGenerator('out_new_edges/train/images','out_new_edges/train/mask','train')
val_data = MyGenerator('out_new_edges/val/images','out_new_edges/val/mask','val')
...
for epoch in range(1, epochs+1):
    ...
    torch.save({'epoch': epoch, 'state_dict': model.state_dict(), 'optimizer' : optimizer.state_dict(),}, 'unetformer_13_40epochs_edges.pth')